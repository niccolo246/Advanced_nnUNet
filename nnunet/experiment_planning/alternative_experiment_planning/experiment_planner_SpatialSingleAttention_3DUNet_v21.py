...
class ExperimentPlanner3DGenericSpatialAttentionUNet_v21(ExperimentPlanner3D_v21):
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        blocks_per_stage_encoder = GenericSpatialSingleAttentionUNet.default_blocks_per_stage_encoder[:len(pool_op_kernel_sizes)]
        blocks_per_stage_decoder = GenericSpatialSingleAttentionUNet.default_blocks_per_stage_decoder[:len(pool_op_kernel_sizes) - 1]

        ref = GenericSpatialSingleAttentionUNet.use_this_for_3D_configuration
        here = GenericSpatialSingleAttentionUNet.compute_approx_vram_consumption(input_patch_size, self.unet_base_num_features,
        ...
        while here > ref:
            ...
            blocks_per_stage_encoder = GenericSpatialSingleAttentionUNet.default_blocks_per_stage_encoder[:len(pool_op_kernel_sizes)]
            blocks_per_stage_decoder = GenericSpatialSingleAttentionUNet.default_blocks_per_stage_decoder[:len(pool_op_kernel_sizes) - 1]
            here = GenericSpatialSingleAttentionUNet.compute_approx_vram_consumption(new_shp, self.unet_base_num_features,
                                                               self.unet_max_num_filters, num_modalities, num_classes,
                                                               pool_op_kernel_sizes, blocks_per_stage_encoder,
                                                               blocks_per_stage_decoder, 2, self.unet_min_batch_size)
        input_patch_size = new_shp

        batch_size = GenericSpatialSingleAttentionUNet.default_min_batch_size
