...
import numpy as np
import torch
from nnunet.network_architecture.generic_modular_custom_UNet import ResidualUNet, get_default_network_config
...
class nnUNetTrainerV2_ResidualUNet(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.network = ResidualUNet(input_channels=self.num_input_channels, base_num_features=self.base_num_features,
