...
import numpy as np
import torch
from nnunet.network_architecture.generic_modular_custom_UNet import InceptionUNet, get_default_network_config
...
class nnUNetTrainerV2_InceptionUNet(nnUNetTrainerV2):
    """Network Trainer for Inception UNet"""
    def initialize_network(self):
        ...
        self.network = InceptionUNet(input_channels=self.num_input_channels, base_num_features=self.base_num_features,
    ...
    #################################################
    #################################################
    # This you can inherit from nnUNetTrainerV2_noDeepSupervision
    #################################################
    #################################################
    #################################################
