...
import numpy as np
import torch
from nnunet.network_architecture.generic_modular_custom_UNet import ResidualAttentionUNet, get_default_network_config
...
class nnUNetTrainerV2_ResidualAttentionUNet(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.network = ResidualAttentionUNet(input_channels=self.num_input_channels, base_num_features=self.base_num_features,
