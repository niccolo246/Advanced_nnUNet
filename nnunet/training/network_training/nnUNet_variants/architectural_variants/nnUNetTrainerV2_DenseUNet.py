...
import numpy as np
import torch
from nnunet.network_architecture.generic_modular_custom_UNet import DenseUNet, get_default_network_config
...
class nnUNetTrainerV2_DenseUNet(nnUNetTrainerV2):
    """Network Trainer for Dense UNet"""
    def initialize_network(self):
        ...
        self.network = DenseUNet(input_channels=self.num_input_channels, base_num_features=self.base_num_features,
