...
class nnUNetTrainerV2_GenericUNet(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.network = GenericUNet(input_channels=self.num_input_channels, base_num_features=self.base_num_features,
